...
VL_ATTR_COLD void Vtestbench_bsg_async_fifo__W40_La___settle__TOP__testbench__DOT__wrapper__DOT__unicore__DOT__dut__DOT__c__BRA__0__KET____DOT__dut__DOT__unicore_lite__DOT__core_minimal__DOT__be__DOT__cosim__DOT__iwb__BRA__0__KET____DOT__ird_fifo__0(Vtestbench_bsg_async_fifo__W40_La* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vtestbench_bsg_async_fifo__W40_La___settle__TOP__testbench__DOT__wrapper__DOT__unicore__DOT__dut__DOT__c__BRA__0__KET____DOT__dut__DOT__unicore_lite__DOT__core_minimal__DOT__be__DOT__cosim__DOT__iwb__BRA__0__KET____DOT__ird_fifo__0\n"); );
    // Body
...
VL_ATTR_COLD void Vtestbench_bsg_async_fifo__W40_La___ctor_var_reset(Vtestbench_bsg_async_fifo__W40_La* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vtestbench_bsg_async_fifo__W40_La___ctor_var_reset\n"); );
    // Body
    vlSelf->w_clk_i = 0;
    vlSelf->w_reset_i = 0;
    vlSelf->w_enq_i = 0;
    ...
    for (int __Vi0=0; __Vi0<1024; ++__Vi0) {
        vlSelf->__PVT__MSYNC_1r1w__DOT__synth__DOT__nz__DOT__mem[__Vi0] = 0;
    }
